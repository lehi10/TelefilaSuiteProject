              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Reportes de tickets generados</h3>
                  </div>
                ...
                @if($tipo==="otro")
                  ...
                  <div class="table-responsive">
                    <table class="table card-table table-vcenter text-nowrap">
                      ...
                      <tbody>
                          <tr>
                            <td style="width: 111px;">{{ date('d', strtotime( $fecha ))  }}</td>
                            <td style="margin-left: 15px;">{{ date('M', strtotime( $fecha ))  }}<br>
                            </td>
                            <td>{{ date('Y', strtotime( $fecha ))  }}</td>
                            <td>
                            <a href="pdfServices?fecha={{$fecha}}" target="_bank">
