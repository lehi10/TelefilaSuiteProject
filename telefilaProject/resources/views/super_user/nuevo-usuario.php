...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.watch.js", "require.js", "nuevo-usuario.css"], "outOfDate":[]};
  ...
  <!-- JS includes -->
  <script type="text/javascript">
   document.write('\x3Cscript src="' + (document.location.protocol == 'https:' ? 'https:' : 'http:') + '//webfonts.creativecloud.com/droid-sans:n4:default.js" type="text/javascript">\x3C/script>');
</script>
   </head>
 <body>
  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   <div class="verticalspacer" data-offset-top="410" data-content-above-spacer="409" data-content-below-spacer="91"></div>
   <div class="colelem" id="u809"><!-- simple frame --></div>
   <div class="clearfix colelem" id="u804-8"><!-- content -->
